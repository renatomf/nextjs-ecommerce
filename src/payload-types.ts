...
export interface Tenant {
  id: string;
  /**
   * This is the name of the store (e.g. Renato's Store)
   */
  name: string;
  /**
...
export interface Product {
  ...
  image?: (string | null) | Media;
  refundPolicy?: ('30-day' | '15-day' | '7-day' | '3-day' | '1-day' | 'no-refunds') | null;
  /**
  ...
  /**
   * if checked, this product wiil not be shown on the public storefront
   */
